...
export function Sidebar({ currentPage, onNavigate, user, isCollapsed, onToggle }: SidebarProps) {
  ...
  return (
    <div className="bg-green-50 border-r border-gray-200 flex flex-col flex-shrink-0" style={{ width: isCollapsed ? '64px' : '288px' }}>
      {/* Toggle Button - Fixed */}
      <div className="h-16 flex items-center px-3 border-b-2 border-gray-200 bg-white">
        <button 
          onClick={onToggle} 
          className="w-10 h-10 flex items-center justify-center hover:bg-green-50 rounded-full transition-colors flex-shrink-0"
